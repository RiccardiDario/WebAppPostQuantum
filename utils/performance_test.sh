...
awk '/^\* SSL connection using/ {print "- Cipher Suite: " substr($0, index($0,$5))} /^\* Server certificate:/ {getline; print "- Signature Algorithm: " substr($0, index($0,$3))}' >> $PERFORMANCE_REPORT_FILE
