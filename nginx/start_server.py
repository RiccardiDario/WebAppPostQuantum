...
RESOURCE_LOG, ACCESS_LOG, OUTPUT_FILE = "/opt/nginx/output/monitor_nginx_filtered.csv", "/opt/nginx/logs/access_custom.log", "/opt/nginx/output/monitor_nginx_filtered.csv"
